  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(min(280px,100%),1fr))] items-start gap-8 px-5 pt-[clamp(44px,6vw,84px)] pb-[clamp(32px,5vw,72px)] sm:gap-10">
        <div data-reveal>
          <p className="text-[clamp(17px,2vw,26px)] leading-[1.4] font-medium text-pretty">
          ...
          <p className="mt-6 font-display text-[clamp(26px,3.2vw,42px)] leading-[1.02] font-extrabold text-dizzy-orange">
        ...
        {/* Sticker sheet: each tile is a drawn mark until a photo is dropped in. */}
