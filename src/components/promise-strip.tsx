    ...
    <section className="grid grid-cols-[repeat(auto-fit,minmax(min(220px,100%),1fr))] border-b-[3px] border-burgundy">
      {promises.map((promise) => (
        ...
        >
          <span
            data-draw
            className="flex size-[38px] flex-none items-center justify-center rounded-full border-2 border-dizzy-orange text-dizzy-orange transition-transform duration-300 group-hover:-rotate-12 group-hover:scale-110"
          >
